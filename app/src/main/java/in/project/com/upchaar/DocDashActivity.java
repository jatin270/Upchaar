...
//
//        take_leave=findViewById(R.id.take)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.doc_dash, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.current_schedule) {
            fragment = new DocDashCurrentApp();
        }
